...
public class JsonApiBodyRequest {
	@JsonProperty("data")
	@Valid
	private List<ChannelRequest> data = new ArrayList<ChannelRequest>();

	public JsonApiBodyRequest data(List<ChannelRequest> data) {
		this.data = data;
		return this;
	}

	public JsonApiBodyRequest addDataItem(ChannelRequest dataItem) {
	...
	public List<ChannelRequest> getData() {
		return data;
	}

	public void setData(List<ChannelRequest> data) {
		this.data = data;
	}
